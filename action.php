...
<?php
    ...
    if($conn->connect_error){
        ...
        $sqlQuery = "select videoURL,poster,Movie_Title,Length_Time,categoryName from moviecategory 
                    ...
                    inner join moviecontent on movieinfo.Movie_Id=moviecontent.Movie_Id where moviecategory.Category_Id='C01'; ";
...
?>
    ...
    <script>
        ...
        // for(let i=0;i<10;i++){
        // moviePost(videourl, posterr, title ,lengthoftime  ,catgrry,  div+i);
        // }
